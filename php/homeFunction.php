			...
			function __construct($connect){
				...
				public function displayPostfunction(){
					...
					while($row = $displayPostQuery->fetch(PDO::FETCH_OBJ)){
						...
						echo  		"<div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 div-display-name'>&nbsp" . ucfirst($username) ."</div>";			
				...
				public function displayPrivateChat($getOnlineId,$getUsereId){
					...
					$displayPrivateChatQuery->execute(
						array(
							':getOnlineId'			=> $getOnlineId, 
							':getInverseOnlineId'	=> $getUsereId, 
							':getUsereId'			=> $getOnlineId,
							':getInverseUsereId'	=> $getUsereId
						)
					);
